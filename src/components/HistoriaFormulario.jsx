...
const HistoriaFormulario = ({ project_id }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      ...
      <h3 className="text-center text-xl font-semibold text-gray-800 m-4">Historia de usuario</h3>
        <div className="mb-6">
        ...
        <hr />
        <h3 className="text-center text-xl font-semibold text-gray-800 m-4">Primer ticket asociado</h3>
